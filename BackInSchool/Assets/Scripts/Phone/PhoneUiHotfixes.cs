...
public class PhoneUiHotfixes : MonoBehaviour
{
    ...
    private void OpenViaManager(string targetName)
    {
        ...
        switch (targetName)
        {
            ...
            case "App_Chat":
                ...
                break;
            case "App_Gallery":
                appManager.OpenApp(PhoneAppId.Gallery);
                break;
            case "App_Settings":
    ...
    private string ResolveTargetPanelForButton(Button button)
    {
        ...
        if (button.name.Contains("Gallery") || button.name.Contains("Music")) return "App_Gallery";
        ...
        if (text != null)
        {
            ...
            if (t.Contains("gallery") || t.Contains("갤러리") || t.Contains("music") || t.Contains("음악")) return "App_Gallery";
